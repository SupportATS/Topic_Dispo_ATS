<%@ Page Title="Vérifier le numéro de téléphone" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VerifyPhoneNumber.aspx.cs" Inherits="Topic_Dispo_ATS.Account.VerifyPhoneNumber" %>
